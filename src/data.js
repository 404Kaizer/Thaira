...
const MONSTERS = {
  ...
  cyclops: {
    n: 'Ciclope', hp: 280, exp: 200, atk: [18, 56], arm: 18, sz: 1.25, col: 0x7a6a5a, tier: 3,
...
mob('firefly', {
  ...
  loot: [['gold', .25, 1, 4], ['glow_gland', .45], ['bug_shell', .1], ['health_potion', .02]]
});
