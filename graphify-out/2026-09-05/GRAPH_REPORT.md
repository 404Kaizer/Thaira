# Graph Report - Jogo  (2026-09-05)

## Corpus Check
- 93 files · ~8,276,419 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2539 nodes · 3849 edges · 164 communities (156 shown, 8 thin omitted)
...
Cohesion: 0.11
Nodes (22): AGUA_CINTILO_A, balancoEm(), CAM, ceuRGB, CHAO_ESCALA, CHAO_ITEM, CHAO_MOEDA, CHUVA_PLANOS (+14 more)
...
### Community 157 - "drawWorld"
Cohesion: 0.15
Nodes (14): camadaNuvem(), ceuNorm(), cloudPass(), derivaAvanca(), dprInt(), drawWorld(), entityBucket(), gradeEmGL() (+6 more)

### Community 159 - "drawFloor"
Cohesion: 0.15
Nodes (17): chamaTremor(), cumeTelhado(), cxDo(), drawCampos(), drawEntity(), drawFloor(), dropShadow(), faixaTelhado() (+9 more)

### Community 160 - "cantoDoTile"
Cohesion: 0.27
Nodes (11): cantoDoTile(), daCasa(), janelaDeTiles(), nevoaDens(), nevoaHora(), nevoaPass(), poolPass(), recorteCeu() (+3 more)

### Community 161 - "_criaturaCrua"
Cohesion: 0.20
Nodes (12): bloomPass(), _criaturaCrua(), facingOf(), frameOf(), halo(), HALO_CACHE, haloGrad(), lightPass() (+4 more)
...
## Knowledge Gaps
- **1329 isolated node(s):** `Adventure.mp3`, `Anywhere.mp3`, `Arrival.mp3`, `Artistry.mp3`, `Autumn Voyage.mp3` (+1324 more)
