# Graph Report - jogo  (2026-08-13)

## Corpus Check
- 38 files · ~3,013,588 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 932 nodes · 1602 edges · 77 communities (75 shown, 2 thin omitted)
- Extraction: 87% EXTRACTED · 12% INFERRED · 1% AMBIGUOUS · INFERRED: 193 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7fed52e1`
...
7. `killMob()` - 14 edges
8. `Golden Guardian Set (Thaira equipment set: blackened plate, gold lion heraldry, red gems)` - 14 edges
9. `useRune()` - 13 edges
10. `updateMobs()` - 13 edges
...
### Community 5 - "game.js"
Cohesion: 0.07
Nodes (45): PREFIXES, SUFFIXES, BONUS_LABEL, BUFF_DESC, BUFF_ICO, BUFF_LABEL, BUFF_RUIM, charId() (+37 more)
...
Cohesion: 0.25
Nodes (18): addMagic(), bloodSpray(), castSpell(), cssCol(), curar(), damageFormula(), dealDamage(), emZonaSegura() (+10 more)
...
Cohesion: 0.16
Nodes (17): abalo(), afterStep(), bindMiniMap(), changeFloor(), chuvaOuvida(), congelar(), finishStart(), killMob() (+9 more)
...
Cohesion: 0.16
Nodes (19): bagAdd(), bindInput(), clickTile(), corpseAt(), dropItem(), fecharJanelas(), hideTip(), itemCell() (+11 more)
...
### Community 24 - "frame"
Cohesion: 0.15
Nodes (19): clamp(), drawMinimap(), empurrar(), frame(), lerpEntity(), lineClear(), noTemplo(), occupied() (+11 more)
...
### Community 77 - "log"
Cohesion: 0.19
Nodes (23): SHOP_STOCK, addExp(), addSkillTry(), canEquip(), comer(), drinkBest(), equipItem(), habilidade() (+15 more)
