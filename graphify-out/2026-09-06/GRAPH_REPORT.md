...
## Corpus Check
- 93 files · ~8,276,646 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2537 nodes · 3843 edges · 164 communities (156 shown, 8 thin omitted)
...
Cohesion: 0.12
Nodes (21): chamaTremor(), cumeTelhado(), cxDo(), drawCampos(), drawEntity(), drawFloor(), dropShadow(), faixaTelhado() (+13 more)
...
Cohesion: 0.11
Nodes (20): AGUA_CINTILO_A, balancoEm(), CAM, camadaNuvem(), ceuNoTile(), ceuRGB, CHAO_ESCALA, CHAO_ITEM (+12 more)
...
### Community 161 - "cantoDoTile"
Cohesion: 0.27
Nodes (10): cantoDoTile(), daCasa(), janelaDeTiles(), nevoaDens(), nevoaHora(), nevoaPass(), poolPass(), recorteCeu() (+2 more)

### Community 162 - "w2s"
Cohesion: 0.27
Nodes (10): creatureSpriteFor(), drawBlood(), drawEffects(), hoverTile(), paraCss(), plateAnchor(), project(), raioVista() (+2 more)
