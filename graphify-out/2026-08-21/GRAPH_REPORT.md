# Graph Report - Jogo  (2026-08-21)

## Corpus Check
- 64 files · ~5,882,090 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1191 nodes · 2101 edges · 97 communities (91 shown, 6 thin omitted)
...
### Community 5 - "game.js"
Cohesion: 0.05
Nodes (50): BONUS_LABEL, BUFF_DESC, BUFF_ICO, BUFF_LABEL, BUFF_RUIM, campoEm(), cellsVazias(), CELULA (+42 more)

### Community 6 - "data.js"
Cohesion: 0.04
Nodes (47): AH, AI, BEST_DIFF, BEST_REVEAL, BEST_STAGE, BIOMA_POOLS, BO, CH (+39 more)

### Community 7 - "render2d.js"
Cohesion: 0.09
Nodes (45): bloomPass(), CAM, camadaNuvem(), campoParticulas(), chamaTremor(), CHAO_ESCALA, CHAO_ITEM, CHAO_MOEDA (+37 more)
...
Cohesion: 0.15
Nodes (23): cdDe(), DANO_TIPOS, abrirMagia(), addSkillTry(), castSpell(), _corTexto(), damageFormula(), estadoDaMagia() (+15 more)
...
Cohesion: 0.10
Nodes (28): SPELLS, alvosPerto(), arrastaJanela(), bindInput(), bindMiniMap(), clamp(), clickTile(), corpseAt() (+20 more)

### Community 19 - "updateMobs"
Cohesion: 0.20
Nodes (19): acordar(), evitaCampo(), habilidade(), hitPlayer(), lineClear(), noTemplo(), occupied(), passoAte() (+11 more)
...
### Community 24 - "colher"
Cohesion: 0.18
Nodes (14): abrirTesouro(), afterStep(), changeFloor(), chaveTile(), chuvaOuvida(), coletaDe(), colher(), colhidoEm() (+6 more)
...
Cohesion: 0.20
Nodes (14): abrirPicker(), HOT_KEYS_DEFAULT, hotAjusta(), hotDefault(), hotKeyLabel(), knownSpells(), renderHotbar(), renderSpells() (+6 more)
...
### Community 89 - "log"
Cohesion: 0.17
Nodes (29): addMagic(), aplicaEstado(), bagAdd(), bancadaTeste(), blessPrice(), canEquip(), comer(), curar() (+21 more)
...
## Knowledge Gaps
- **351 isolated node(s):** `dia-vila.mp3`, `dia-celta.mp3`, `dia-campina.mp3`, `dia-taverna.mp3`, `dia-menestrel.mp3` (+346 more)
