# Graph Report - Jogo  (2026-08-16)

## Corpus Check
- 43 files · ~5,946,247 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1047 nodes · 1818 edges · 90 communities (85 shown, 5 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 1% AMBIGUOUS · INFERRED: 192 edges (avg confidence: 0.85)
...
### Community 1 - "art.js"
Cohesion: 0.06
Nodes (56): BORDER_CACHE, borderSprite(), _canvas(), _canvas2(), _chapado(), cloudTexture(), contactShadow(), _cracks() (+48 more)
...
### Community 5 - "game.js"
Cohesion: 0.08
Nodes (39): blessPrice(), BONUS_LABEL, BUFF_DESC, BUFF_ICO, BUFF_LABEL, BUFF_RUIM, cycleVoc(), dropItem() (+31 more)

### Community 6 - "data.js"
Cohesion: 0.05
Nodes (37): AH, AI, BEST_DIFF, BEST_REVEAL, BEST_STAGE, BIOMA_POOLS, COLETA, ELEM (+29 more)
...
### Community 8 - "log"
Cohesion: 0.21
Nodes (25): addExp(), addMagic(), addSkillTry(), canEquip(), castSpell(), comer(), curar(), drinkBest() (+17 more)
...
### Community 13 - "frame"
Cohesion: 0.16
Nodes (16): bindMiniMap(), changeFloor(), clamp(), drawMinimap(), empurrar(), finishStart(), frame(), lerpEntity() (+8 more)
...
### Community 18 - "killMob"
Cohesion: 0.32
Nodes (8): abrirTesouro(), congelar(), descLoot(), killMob(), mkItem(), newPlayer(), rollRarity(), spawnCorpse()
...
### Community 55 - "dealDamage"
Cohesion: 0.16
Nodes (19): bloodSpray(), clickTile(), _corTexto(), cssCol(), damageFormula(), dealDamage(), emZonaSegura(), fxBurst() (+11 more)
...
### Community 78 - "bindInput"
Cohesion: 0.19
Nodes (17): afterStep(), alvosPerto(), bagAdd(), bindInput(), chaveTile(), chuvaOuvida(), coletaDe(), colher() (+9 more)
...
### Community 85 - "updateMobs"
Cohesion: 0.21
Nodes (17): abalo(), CONSUMIVEL(), habilidade(), hitPlayer(), lineClear(), noTemplo(), occupied(), passoAte() (+9 more)
...
## Knowledge Gaps
- **306 isolated node(s):** `dia-vila.mp3`, `dia-celta.mp3`, `dia-campina.mp3`, `dia-taverna.mp3`, `dia-menestrel.mp3` (+301 more)
