# Graph Report - Jogo  (2026-09-02)

## Corpus Check
- 95 files · ~8,197,449 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2573 nodes · 3857 edges · 162 communities (153 shown, 9 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.76)
...
### Community 1 - "art.js"
Cohesion: 0.03
Nodes (57): BORDER_CACHE, CAMPO_CACHE, CAMPO_DRAW, CAMPO_EIXO_Y, CAMPO_GIRA, carregaTerrenos(), CERCA_CACHE, CRIA_CACHE (+49 more)
...
Cohesion: 0.05
Nodes (77): AGUA_CINTILO_A, balancoEm(), bloomPass(), CAM, camadaNuvem(), cantoDoTile(), ceuRGB, chamaTremor() (+69 more)
...
Cohesion: 0.03
Nodes (57): achados, alvo, archotes, BOSQUE, buracos, C, CABO, CAMPO (+49 more)
...
### Community 76 - "build_objetos.py"
Cohesion: 0.07
Nodes (45): catalogo(), cor_material(), despolui(), encaixa(), franja_magenta(), grava_fonte(), main(), mascara_objeto() (+37 more)
...
Cohesion: 0.15
Nodes (22): bordaProf(), borderSprite(), campoSprite(), _canvas(), CLOUD_CACHE, cloudTexture(), contactShadow(), edgeMask() (+14 more)
...
### Community 116 - "decoSprite"
Cohesion: 0.50
Nodes (4): decoSprite(), _poly(), _rc(), shade()
...
### Community 158 - "test_tools.js"
Cohesion: 0.18
Nodes (9): a, b, conta(), falhas, fs, html, path, pincel (+1 more)

### Community 159 - "varrokgaard2.js"
Cohesion: 0.03
Nodes (47): abertos, achados, alvo, ALVOS, ARV, BOSQUE, C, CABO (+39 more)

### Community 160 - "eAgua"
Cohesion: 0.22
Nodes (9): discoTerra(), eAgua(), emTerra(), linhaTerra(), NB4, perimetro(), poliTerra(), subida() (+1 more)
...
## Knowledge Gaps
- **1368 isolated node(s):** `Adventure.mp3`, `Anywhere.mp3`, `Arrival.mp3`, `Artistry.mp3`, `Autumn Voyage.mp3` (+1363 more)
