# Graph Report - Jogo  (2026-08-25)

## Corpus Check
- 77 files · ~6,380,541 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1420 nodes · 2465 edges · 104 communities (99 shown, 5 thin omitted)
...
### Community 13 - "recalc"
Cohesion: 0.11
Nodes (29): blessPrice(), canEquip(), cellsVazias(), CELULA, descLoot(), dropItem(), equipItem(), fmtBon() (+21 more)
...
Cohesion: 0.20
Nodes (18): DANO_TIPOS, abrirMagia(), castSpell(), damageFormula(), estadoDaMagia(), fichaLinhas(), magiaHTML(), magiaInfo() (+10 more)
...
### Community 38 - "log"
Cohesion: 0.14
Nodes (29): abrirTesouro(), addExp(), addMagic(), addSkillTry(), afterStep(), aplicaEstado(), campoDano(), campoEm() (+21 more)
...
Cohesion: 0.14
Nodes (21): SPELLS, alvosPerto(), bagAdd(), bancadaTeste(), bindInput(), chaveTile(), clickTile(), coletaDe() (+13 more)
...
## Knowledge Gaps
- **450 isolated node(s):** `dia-vila.mp3`, `dia-celta.mp3`, `dia-campina.mp3`, `dia-taverna.mp3`, `dia-menestrel.mp3` (+445 more)
