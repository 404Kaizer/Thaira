# Graph Report - Jogo  (2026-08-17)

## Corpus Check
- 43 files · ~6,039,339 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1068 nodes · 1863 edges · 90 communities (86 shown, 4 thin omitted)
- Extraction: 89% EXTRACTED · 10% INFERRED · 1% AMBIGUOUS · INFERRED: 191 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `18d40755`
...
1. `log()` - 34 edges
2. `castSpell()` - 24 edges
3. `bindInput()` - 24 edges
4. `frame()` - 21 edges
5. `renderBars()` - 18 edges
6. `recalc()` - 17 edges
7. `dealDamage()` - 15 edges
8. `playerAttack()` - 15 edges
9. `colher()` - 15 edges
10. `updateMobs()` - 14 edges
...
### Community 1 - "art.js"
Cohesion: 0.05
Nodes (59): BORDER_CACHE, borderSprite(), _canvas(), _canvas2(), _chapado(), cloudTexture(), contactShadow(), _cracks() (+51 more)

### Community 2 - "test.js"
Cohesion: 0.04
Nodes (41): apAtk, apDef, B, C, chefes, comCharm, comum, ctx (+33 more)
...
### Community 5 - "game.js"
Cohesion: 0.07
Nodes (33): bloodSpray(), BONUS_LABEL, BUFF_DESC, BUFF_ICO, BUFF_LABEL, BUFF_RUIM, cycleVoc(), ENTRY_SCREENS (+25 more)
...
Cohesion: 0.11
Nodes (37): bloomPass(), CAM, camadaNuvem(), cloudPass(), creatureSpriteFor(), _criaturaCrua(), dprInt(), drawBlood() (+29 more)

### Community 8 - "log"
Cohesion: 0.21
Nodes (30): abalo(), addExp(), addMagic(), addSkillTry(), canEquip(), castSpell(), comer(), cssCol() (+22 more)

### Community 9 - "world.js"
Cohesion: 0.13
Nodes (28): POIS, ambienteAgora(), CEU, climaAgora(), corDoCeu(), corFora(), DIRS, distT() (+20 more)
...
Cohesion: 0.25
Nodes (14): noTemplo(), occupied(), passoAte(), passoDeFuga(), passoVagar(), refreshSpawns(), removeMob(), reservarVagas() (+6 more)
...
Cohesion: 0.26
Nodes (12): alvosPerto(), bagAdd(), bindInput(), corpseAt(), lootAll(), lootTempo(), lootTile(), openLoot() (+4 more)
...
### Community 24 - "frame"
Cohesion: 0.13
Nodes (21): arrastaJanela(), bindMiniMap(), chuvaOuvida(), clamp(), clickTile(), drawMinimap(), empurrar(), finishStart() (+13 more)
...
Cohesion: 0.13
Nodes (14): _corpo_medio, n, v, ext, rev, rune, n, v (+6 more)
...
### Community 49 - "itemStats"
Cohesion: 0.29
Nodes (11): blessPrice(), dropItem(), fmtBon(), itemCell(), itemStats(), playerDeath(), renderInv(), renderShop() (+3 more)
...
Cohesion: 0.24
Nodes (12): DANO_TIPOS, abrirMagia(), _corTexto(), magiaHTML(), magiaInfo(), renderCombatStats(), renderResChips(), renderSpells() (+4 more)
...
### Community 85 - "colher"
Cohesion: 0.16
Nodes (18): abrirTesouro(), afterStep(), changeFloor(), chaveTile(), coletaDe(), colher(), colhidoEm(), congelar() (+10 more)
...
Cohesion: 0.17
Nodes (11): abrirJanela(), { app, BrowserWindow, Menu }, DEV, fs, http, iniciar(), path, servidor (+3 more)

### Community 88 - "lootEV"
Cohesion: 0.67
Nodes (3): lootEV(), lootQtd(), lootVal()

### Community 89 - "renderHotbar"
Cohesion: 0.28
...
## Knowledge Gaps
- **313 isolated node(s):** `dia-vila.mp3`, `dia-celta.mp3`, `dia-campina.mp3`, `dia-taverna.mp3`, `dia-menestrel.mp3` (+308 more)
