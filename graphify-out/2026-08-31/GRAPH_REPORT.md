# Graph Report - Jogo  (2026-08-31)

## Corpus Check
- 93 files · ~8,170,126 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2471 nodes · 3740 edges · 159 communities (151 shown, 8 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 231 edges (avg confidence: 0.76)
...
### Community 1 - "art.js"
Cohesion: 0.04
Nodes (56): BORDER_CACHE, CAMPO_CACHE, CAMPO_DRAW, CAMPO_EIXO_Y, CAMPO_GIRA, carregaTerrenos(), CERCA_CACHE, CRIA_CACHE (+48 more)
...
### Community 6 - "data.js"
Cohesion: 0.03
Nodes (56): AH, AI, BEST_DIFF, BEST_REVEAL, BEST_STAGE, BIOMA_POOLS, BO, CAMPO_ACIMA (+48 more)

### Community 7 - "render2d.js"
Cohesion: 0.06
Nodes (74): AGUA_CINTILO_A, balancoEm(), bloomPass(), CAM, camadaNuvem(), cantoDoTile(), ceuRGB, chamaTremor() (+66 more)
...
Cohesion: 0.06
Nodes (60): abrigado(), ambienteAgora(), ambienteDe(), calcDentro(), calcDistAgua(), carregaMundo(), CEU, chaoMaisPerto() (+52 more)
...
## Knowledge Gaps
- **1300 isolated node(s):** `Adventure.mp3`, `Anywhere.mp3`, `Arrival.mp3`, `Artistry.mp3`, `Autumn Voyage.mp3` (+1295 more)
