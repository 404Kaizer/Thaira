# Graph Report - Jogo  (2026-08-20)

## Corpus Check
- 62 files · ~5,818,628 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1153 nodes · 2020 edges · 93 communities (88 shown, 5 thin omitted)
- Extraction: 90% EXTRACTED · 9% INFERRED · 1% AMBIGUOUS · INFERRED: 182 edges (avg confidence: 0.85)
...
### Community 5 - "game.js"
Cohesion: 0.05
Nodes (49): SPELLS, abrirPicker(), BONUS_LABEL, BUFF_DESC, BUFF_ICO, BUFF_LABEL, BUFF_RUIM, cellsVazias() (+41 more)
...
Cohesion: 0.16
Nodes (19): alvosPerto(), bagAdd(), bindInput(), chaveTile(), coletaDe(), colher(), colhidoEm(), corpseAt() (+11 more)

### Community 19 - "frame"
Cohesion: 0.11
Nodes (32): acordar(), afterStep(), arrastaJanela(), bindMiniMap(), changeFloor(), chuvaOuvida(), clamp(), empurrar() (+24 more)
...
Cohesion: 0.12
Nodes (25): abrirTesouro(), addExp(), blessPrice(), CELULA, congelar(), descLoot(), dropItem(), fecharJanelas() (+17 more)
...
Cohesion: 0.14
Nodes (32): DANO_TIPOS, abrirMagia(), addMagic(), bloodSpray(), castSpell(), _corTexto(), cssCol(), curar() (+24 more)
...
### Community 89 - "log"
Cohesion: 0.17
Nodes (26): abalo(), addSkillTry(), aplicaEstado(), canEquip(), clickTile(), comer(), drinkBest(), equipItem() (+18 more)
...
## Knowledge Gaps
- **347 isolated node(s):** `dia-vila.mp3`, `dia-celta.mp3`, `dia-campina.mp3`, `dia-taverna.mp3`, `dia-menestrel.mp3` (+342 more)
